...
enum class UserLevel(val string: String, val xp: Int) {
    ...
    LEVEL_2(string = "Level 2", xp = 10000), // read all list
    LEVEL_3(string = "Level 3", xp = 20000), // add/ decline
    LEVEL_4(string = "Level 4", xp = 30000), // edit pending food before added
    LEVEL_5(string = "Level 5", xp = 100000),;  // suprize
